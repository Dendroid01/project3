    ...
    return (
        <div className="flex flex-col items-center px-5 text-center">
            ...
            <div className="mt-6 relative">
                ...
                <div className="absolute -top-2 -right-2 bg-skyBlue text-darkCyan text-[10px] font-bold px-2 py-0.5 rounded-full">
                    LIVE
                </div>
            </div>
            ...
            <p className="text-gray text-lg font-medium mt-1">Partly Cloudy</p>

            <div className="flex gap-6 mt-3 text-gray font-medium">
                <span>H: 26°</span>
                <span>L: 14°</span>
            </div>
        </div>
